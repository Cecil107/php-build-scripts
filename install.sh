...
echo "system>   2) Linux "
echo "system>   3) MacOS x64(64-bit)"
...
read -e -p "system> Number (e.g. 1): " a </dev/tty
 case "$a" in 
	...
	2 ) z="PHP_7.0.2_x86_Linux.tar.gz";;
	3 ) z="PHP_7.0.2_x86-64_MacOS.tar.gz";;
	4 ) exit 1;;
...
wget https://dl.bintray.com/pocketmine/PocketMine/PHP_7.0.3_x86-64_MacOS.tar.gz >>./$wp 2>>./$wp
	chmod 777 PHP_7.0.3_x86_Linux.tar.gz >>./$lp 2>>./$lpe
	tar zxvf PHP_7.0.3_x86_Linux.tar.gz >>./$lp 2>>./$lpe
	rm -r PHP_7.0.3_x86_Linux.tar.gz >>./$lp 2>>./$lpe
else
wget https://dl.bintray.com/pocketmine/PocketMine/PHP_7.0.3_x86-64_MacOS.tar.gz >>./$wp 2>>./$wp
	chmod 777 PHP_7.0.3_x86_Linux.tar.gz >>./$lp 2>>./$lpe
	tar zxvf PHP_7.0.3_x86_Linux.tar.gz >>./$lp 2>>./$lpe
